                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="col-md-2 col-sm-2 col-lg-2">   
                                 <label for="linkytb">Thông Báo Hiện Lại Sau</label>
                                <div class="form-group">
                                    <div class="form-line">
                        ...
                        <div class="col-md-2 col-sm-2 col-lg-2">   
                                 <label for="linkytb">Bên Gạch Thẻ</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="web_brick" class="form-control show-tick" tabindex="-98">
                                            <option value="<?php echo $web_brick['site'];?>"><?php if($web_brick['site'] == 'thesieure') echo 'doithe.vn'; else echo 'NapTuDong.Com';?></option>
                                            <option value="thesieure">doithe.vn</option>
                        ...
                        <div class="col-md-3 col-sm-3 col-lg-3">   
                                 <label for="linkytb">Partner ID</label>
                                <div class="form-group">
                                    <div class="form-line">
                        ...
                        <div class="col-md-3 col-sm-3 col-lg-3">   
                                 <label for="linkytb">Partner Key</label>
                                <div class="form-group">
                                    <div class="form-line">
