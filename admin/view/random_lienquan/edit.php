...
if(isset($_POST['sua_goi'])) {
	...
	mysqli_query($kun->connect_db(), "UPDATE `random_lienquan` SET `name`='".$_POST['name']."', `giatien`='".$_POST['giatien']."', `thumb`='".$_POST['thumb']."' WHERE `id`='".$_POST['id']."'");
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>SỬA GÓI LIÊN QUÂN RANDOM "<b><?php echo $row['name'];?></b>"</h2>
