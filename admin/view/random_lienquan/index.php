...
if(isset($_POST['them_goi'])) {
	...
	mysqli_query($kun->connect_db(), "INSERT INTO `random_lienquan` (`name`, `cname`, `thumb`, `giatien`, `status`, `time`) VALUES ('".$_POST['name']."', '".$_POST['cname']."', '".$_POST['thumb']."', '".$_POST['giatien']."', 'false', '".time()."')");
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>THÊM GÓI LIÊN QUÂN RANDOM</h2>
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>DANH SÁCH GÓI RANDOM LIÊN QUÂN</b>
                            </h2>
...
<tbody>
	...
	<?php
		$sql = mysqli_query($kun->connect_db(), "SELECT * FROM `random_lienquan` ORDER BY `time` DESC");
...
<script type="text/javascript">
	$("#name").change(function(){
             $.ajax({
                    url : "/admin/model/random_lienquan/get_cname.php",
                    type : "post",
                    dataType:"text",
                    data : {
                         name : $('#name').val()
...
function del(id, name) {
	 if (confirm('Bạn có chắc muốn xóa '+name+'?')) {
	 		location.href = '?modun=random_lienquan&act=delete&id='+id;
		} else {
...
function options(id, element) {
		...
		if(checkbox.prop("checked") == true){
	 			$.ajax({url: '/admin/model/random_lienquan/status_random.php',
	                type: 'POST',
	                dataType: 'text',
	                data: {
	                    id: id,
