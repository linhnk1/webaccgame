...
if(isset($_POST['submit'])) {
    if($_POST['goi']) {
        ...
        mysqli_query($kun->connect_db(), "INSERT INTO `random_lienquan_nick` (`cname`, `username`, `password`, `status`, `time`) VALUES ('".$_POST['goi']."', '".$data[0]."', '".$data[1]."', 'true', '".time()."')");
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>THÊM NICK LIÊN QUÂN RANDOM</h2>
                        </div>
                        <div class="body">
    ...
    <?php
        ...
        while ($row = mysqli_fetch_array($sql)) { ?> 
                            ...
                            <?php } ?>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input name="listacc" rows="8" class="form-control no-resize" placeholder="Tài Khoản|Mật Khẩu"><?php echo $_POST['listacc'];?>
                                    </div>
                                </div>
                    </div>
