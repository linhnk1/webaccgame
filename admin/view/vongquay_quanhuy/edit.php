...
$row = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `vongquay_quanhuy` WHERE `id`='".$_GET['id']."'"));
...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                SỬA VÒNG QUAY LIÊN QUÂN "<?php echo $row['name'];?>"
        ...
        if(isset($_POST['submit'])) {
                ...
                mysqli_query($kun->connect_db(), "UPDATE `vongquay_quanhuy` SET `name` = '".$name."', `mota` = '".$mota."', `giatien` = '".$giatien."' WHERE `id`='".$_GET['id']."'");

                mysqli_query($kun->connect_db(), "UPDATE `vongquay_1uanhuy_gift` 
                    SET 
...
<?php 
$rows = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `vongquay_quanhuy_gift` WHERE `id_vongquay`='".$_GET['id']."'"));
$item = 'item_';
for($x=1;$x<=8;$x++) {
$items = $rows[$item.$x];
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" id="quanhuy_<?php echo $x;?>" name="quanhuy_<?php echo $x;?>" min="0" class="form-control" placeholder="Quân Huy Trúng" required="" value="<?php echo $json['quanhuy'];?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
