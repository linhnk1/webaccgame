...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <b>DANH SÁCH VÒNG QUAY LIÊN QUÂN</b>
                            </h2>
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="?modun=vongquay_quanhuy&act=add" class=" waves-effect waves-block">Thêm Vòng Quay</a></li>
                                    </ul>
                                </li>
                            </ul>
...
<tbody>
	...
	<?php
		$sql = mysqli_query($kun->connect_db(), "SELECT * FROM `vongquay_quanhuy` ORDER BY `time` DESC");
		...
		<td>
		   <a href="?modun=vongquay_quanhuy&act=edit&id=<?php echo $row['id'];?>">
...
function del(id, name) {
	 if (confirm('Bạn có chắc muốn xóa '+name+'?')) {
	 		location.href = '?modun=vongquay_quanhuy&act=delete&id='+id;
		} else {
...
function options(id, element) {
		...
		if(checkbox.prop("checked") == true){
	 			$.ajax({url: '/admin/model/vongquayquanhuy/status_vongquay.php',
	                type: 'POST',
	                dataType: 'text',
	                data: {
	                    id: id,
