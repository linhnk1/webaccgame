...
if(isset($_POST['congtienpost'])) {
	if(isset($_POST['id_user'])) {
		mysqli_query($kun->connect_db(), "UPDATE `users` SET `money` = '".$_POST['money']."', `quanhuy`='".$_POST['quanhuy']."' WHERE `id` = '".$_POST['id_user']."'");
                        ...
                        <div class="body" style="height: 370px;">
		                    <form method="post" action="">
	                           <input type="hidden" name="id_user" value="<?php echo $current_user['id'];?>">
		                    	...
		                    	<div class="col-lg-4 col-sm-12 col-md-4">
	                                <label for="username">Quân Huy Hiện Tại</label>
	                                <div class="form-group">
	                                    <div class="form-line">
	                                        <input name="quanhuy" type="text" class="form-control" value="<?php echo $current_user['quanhuy'];?>" required>
	                                    </div>
	                                </div>
								</div>
