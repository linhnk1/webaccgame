...
<div class="modal-header">
    ...
    <h4 class="modal-title">Xác nhận acc random liên quân</h4>
</div>
                <div class="modal-body" id="buy">
                    <p style="display: none;" id="result" style="color:#000;"></p>
				<table class="table table-striped">
					<tbody><tr>
						<th colspan="2">Xác nhận mua acc random liên quân mã số #<?php echo $row['id'];?></th>
					</tr>
						<tr>
							<td>Nhà phát hành:</td>
						...
						<tr>
							<td>Loại:</td>
							<th class="text-danger">Acc Random liên quân</th>
						</tr>
						<tr>
							<td>Giá tiền:</td>
