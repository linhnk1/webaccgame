...
<div class="c-layout-sidebar-content ">
				...
				<div class="c-content-title-1">
					<h3 class="c-font-uppercase c-font-bold">Lịch sử rút quân huy</h3>
	...
	while($row = mysqli_fetch_array($result)) {
		...
		?>
                                    <tr>
                                        ...
                                        <td><?php echo $xss->xss_clean($row['taikhoan']);?></td>
                                        <td><?php echo $xss->xss_clean($row['matkhau']);?></td>                                        
                                        <td><span class="c-font-bold text-danger"><?php echo number_format($xss->xss_clean($row['quanhuy']));?> Quân Huy</span></td>
...
<?php
if ($tong > $kmess){
echo '<center>' . $kun->phantrang('/user/lichsurutquanhuy/', $start, $tong, $kmess) . '</center>';
}
?></div>
