                    ...
                    <div class="item item-left">
                      ...
                      <section class="rotation">
                        <div class="play-spin">
                            ...
                            <img style="width: 80%;max-width: 80%;opacity: 1;" src="<?php echo $kun->vongquaykimcuong_image($_GET['id'], 'image');?>" alt="Play" id="rotate">  
                        </div>
                        <div class="text-center"> 
							<section class="dropdownlist" style="width: 100%;padding: 0px;text-align: center;">
                            ...
                            <div class="ppk">
                                <div class="classWithPad">
                                    ...
                                    <div class="news_image">
                                        ...
                                        <a href="/vongquaykimcuong/<?php echo $kun->rewrite($row['name'])?>-<?php echo $row['id'];?>.html" class="thumb-img" style="position: relative;display: block">
                                        <img src="<?php echo $kun->vongquaykimcuong_image($row['id'], 'thumb');?>" alt="<?php echo $row['name'];?>"></a></div>
