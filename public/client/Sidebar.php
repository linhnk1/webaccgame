<div class="col-span-8 sm:col-span-3 md:col-span-2 lg:col-span-2 xl:col-span-2 lg:px-0 px-2">
    <div class="mb-4 v-menu-account">
        ...
        <ul class="pl-2 text-gray-800">
            <li class="py-1 border-b border-gray-200"><a href="<?=BASE_URL('Auth/Profile');?>" class=""><span
    ...
    <div class="my-4 v-menu-account">
        ...
        <ul class="pl-2 text-gray-800 font-medium">
            ...
            <li class="py-1 border-b border-gray-200"><a href="<?=BASE_URL('nap-tien-qua-ngan-hang/');?>" aria-current="page"><span class="relative mr-2 text-lg"
                        style="top:1.5px;"><i class="bx bxs-credit-card"></i></span>Giao dịch qua ATM/MOMO</a></li>
            <li class="py-1 border-b border-gray-200">
