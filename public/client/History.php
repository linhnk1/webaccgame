                        ...
                        <table id="datatable" class="table-auto w-full scrolling-touch min-w-850">
                            ...
                            <tbody class="text-sm font-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-sm text-gray-800 text-left px-1 py-1 border-b"><?=$groups['title'];?></td>
                                    <td class="text-sm text-gray-800 text-left px-1 py-1 border-b"><?=$category['title'];?></td>
                                    <td class="text-sm text-gray-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[0];?></td>
                                    <td class="text-sm text-gray-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[1];?></td>
                                    <td class="text-sm text-gray-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[2];?></td>
