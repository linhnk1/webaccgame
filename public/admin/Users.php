...
if(isset($_POST['XoaChuyenMuc']) && $getUser['level'] == 'admin' )
{
    ...
    $CMSNT->remove("users", " `id` = '$delete_id' ");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($row['username'] != 'admin') { ?>    
                                                <button class="btn btn-danger btnDelete" data-title="<?=$row['username'];?>"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticDeleteLabel">XÓA USER</h5>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Xóa user</label>
                        <div class="col-sm-8">
                            <div class="form-line">
